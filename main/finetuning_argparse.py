...
def get_argparse():
    ...
    parser.add_argument("--data_dir", default="/home/mchen/NLP/BERT-NER-Pytorch/DATA_DIR", type=str)
    parser.add_argument("--model_type", default="bert", type=str,
                        help="Model type selected in the list: ")
    parser.add_argument("--model_name_or_path", default="bert-base-chinese", type=str,
                        help="Path to pre-trained model or shortcut name selected in the list: ")
    parser.add_argument("--output_dir", default="/home/mchen/NLP/BERT-NER-Pytorch/OUTPUT_DIR", type=str,
    ...
    parser.add_argument("--overwrite_output_dir", default="/home/mchen/NLP/BERT-NER-Pytorch/OUTPUT_DIR", type=str,
