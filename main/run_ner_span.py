...
from processors.ner_metrics import SpanEntityScore
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    # epoch_iterator = tqdm(eval_features, desc="Iteration", disable=args.local_rank not in [-1, 0])
    for step, f in enumerate(eval_features):
        ...
        # print("s_l:", start_logits)
        # print("e_l:", end_logits)
...
def predict(args, model, tokenizer, prefix=""):
    ...
    f_results = []
    output_predict_file = os.path.join(pred_output_dir, prefix, "span_test_predict.json")
